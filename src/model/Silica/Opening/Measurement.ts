...
import { Angle, Distance } from '~model/Numbers';
 ...
 * @category Location
 */
export type Location = 'inside' | 'center' | 'outside';
/**
 * Codec for `MeasurementLocation`.
 *
 * @since 0.4.0
 * @category Location
 */
export const Location: t.Type<Location> = t.keyof({
	inside: true,
	center: true,
	outside: true,
});
